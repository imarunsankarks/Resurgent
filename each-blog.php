...
<body>
        ...
        <main id="main">
            ...
            <div id="read-trigger">
                <section id="blog-details">
                    <div class="container">
                        <div class="row">
                            <p class="posted-date"><a href="blogs.php">Blogs</a> - Posted on 21 March 2024</p>
                            <div class="blog-main-img">
                                <img src="./assets/home/banner.webp" alt="">
                                <h1 class="blogs-title">
                                    How to Deploy Complex
                                    AV Solutions Across Nations?
                                </h1>
                            </div>
                        </div>
                        <!-- ---------------------blog-content------------------- -->
            ...
            <section class="sec-padding">
                <div class="container">
                    <!-- <div class="row pt-4 pb-5 align-items-center sectors-head g-5 g-md-0">
                        ...
                        <div class="col-md-6">
                            <form>
                                <input class="w-100" type="text" placeholder="search here...">
    ...
    <script>
    gsap.set(".reading-status", {
        width: 0,
    });
    gsap.to(".reading-status", {
        scrollTrigger: {
